...
//        (activity as MainActivity).tampilMyFriendsFragment()
    ...
    private fun validasiInput(){
        ...
        when{
            namaInput.isEmpty()-> edtName?.error = "Nama tidak boleh kospong"
            genderInput.equals("Pilih Gender")-> tampilToast("Gender Harys dipilih")
    ...
    private fun tampilToast(message : String){ Toast.makeText(requireActivity(),message, Toast.LENGTH_SHORT).show()
    }
